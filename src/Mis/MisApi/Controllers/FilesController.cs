using csumathboy.MisApi.Extensions;
using csumathboy.MisApi.Utilities;
...
public class FilesController : ControllerBase
{
    ...
    public FilesController(ILogger<FilesController> logger, IConfiguration config, IHttpContextAccessor httpContextAccessor)
    {
        ...
        _targetFolderPath = Path.Combine(_targetFolderPath, "Files/Uploads").Replace("file:\\",string.Empty);
    ...
    public async Task<IActionResult> Upload()
    {
        ...
        if (!string.IsNullOrEmpty(trustedFileNameForFileStorage))
        {
            ...
            return Ok($"{host}/Files/Uploads/{Path.GetFileName(trustedFileNameForFileStorage)}");
        }
        else
